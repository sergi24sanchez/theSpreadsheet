...
class ISpreadsheetControllerForChecker(ABC):
    ...
    # @param coord   a string representing a coordinate in spreadsheet ('A10', for instance).
    #
    # @return a string containing the textual representation of a formula WITH the initial '=' character. Example "=A1*B5*SUMA(A2:B27)"
    #
    ...
    # (this is o because the marker shall look for files within the folder where testing classes are placed). The
